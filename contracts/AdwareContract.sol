...
contract Adware {
    ...
    constructor(
        ...
        startingBidPrice = _startingBidPrice; // 3000000000000000 | (0.003 x 10^18)  | 0.003 ETH ($6)
        videoAdSpotPrice = _videoAdSpotPrice; // 500000000000000  | (0.0005 x 10^18) | 0.0005 ETH ($1.5)
    }
    ...
    function claimBoostReward(uint256 tokenId) public {
        ...
        require(success, "Failed to send FRXETH");
